...
//
// Selection algorithm (per transport and crypto architecture):
...
import { createNodeCryptoProvider } from "./adapters/node/index.js";
import { createWebCryptoProvider } from "./adapters/webcrypto/index.js";
