...
//
// Parses an optional local pywa checkout at PYWA_ERRORS_PATH at test time and extracts
...
const PYWA_ERRORS_PATH = "an optional local pywa checkout at PYWA_ERRORS_PATH";
