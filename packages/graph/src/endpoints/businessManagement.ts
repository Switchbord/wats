...
import { defineEndpoint, type EndpointInvokeOptions } from "../endpoint";
import { GraphRequestValidationError } from "../errors";
import {
  assertRepeatedlyDecodedSafePathId
} from "../internal/validation/paths";
import {
  assertQueryString as assertInternalQueryString
} from "../internal/validation/strings";
import { assertJoinedStringQueryArray } from "../internal/validation/arrays";
import { sanitizeHeaderInit } from "../internal/validation/headers";
import {
