...
describe("wats config validate", () => {
  ...
  test("valid config summaries do not echo token-like or path-like profile names", () => {
    ...
    config.defaultProfile = "EAA_TEST_ACCESS_TOKEN_DO_NOT_PRINT_1234567890";
    config.profiles = {
      EAA_TEST_ACCESS_TOKEN_DO_NOT_PRINT_1234567890: (config.profiles as JsonRecord).local as JsonRecord,
  ...
  test("missing, empty, whitespace-ish, and unknown-flag inputs fail closed without echoing attacker values", () => {
    const cases = [
      ...
      ["--config", "EAA_TEST_ACCESS_TOKEN_DO_NOT_PRINT_1234567890"]
    ];
  ...
  test("malformed and schema-invalid config print ConfigValidationError taxonomy without stack traces or secrets", () => {
    ...
    writeFileSync(malformedPath, "{ not json and EAA_TEST_ACCESS_TOKEN_DO_NOT_PRINT_1234567890", "utf8");
    ...
    tokenLikeProfileConfig.defaultProfile = "EAA_TEST_ACCESS_TOKEN_DO_NOT_PRINT_1234567890";
    ...
    tokenLikeNestedConfig.defaultProfile = "EAA_TEST_ACCESS_TOKEN_DO_NOT_PRINT_1234567890";
