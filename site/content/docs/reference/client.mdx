...
description: "The public GraphClient API surface: configuration types, request lifecycle, and validation taxonomy."
---
...
- `transport?: Transport` — defaults to `createFetchTransport()`. Inject a custom `Transport` to add retry, auth-refresh, tracing, or to mock requests in tests. See the [Transport and Testing guide](/docs/guides/transport-and-testing).
