...
The substrate is intentionally tiny. The heavy lifting lives in what it composes: the [`TypedFilter`](/docs/reference/filters) surface (matching), the [`TypedRouter`](/docs/reference/router) (dispatch), and the [`WhatsApp`](/docs/reference/whatsapp-facade) facade (composition root).
