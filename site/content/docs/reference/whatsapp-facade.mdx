...
description: "The WATS-26 / Arch-L WhatsApp composition root: what it binds, what it exposes, and when to bypass it."
---

<DocMeta status="active" lastReviewed="2026-04-28" appliesTo="0.3.x-alpha-tooling (@wats/core)" />
