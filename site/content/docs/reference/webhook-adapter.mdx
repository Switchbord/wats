...
## Service-layer ingestion (WATS-201)
...
2. **Finite depth gate.** The authenticated parsed envelope is rejected with
   `400 payload_depth_exceeded` when any normalized update's nesting depth
