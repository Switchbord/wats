...
`sequential` (default) — the router awaits handlers one at a time, in registration order. Side-effects observe registration order exactly. This is the recommended default.
