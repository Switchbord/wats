...
description: "The experimental @wats/persistence package: durable runtime state, SQLite/Postgres adapter contract, migrations, and idempotency."
---

<DocMeta status="experimental" lastReviewed="2026-05-25" appliesTo="WATS-48, WATS-87, WATS-120, WATS-121" />
