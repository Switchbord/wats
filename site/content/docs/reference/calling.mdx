...
shape-only. The lifecycle callables, permission reader, call-button/deep-link helpers, and calling webhook normalizers are covered by MockTransport and synthetic webhook tests. Live call sessions, WebRTC/media signaling, and calling-access provisioning remain credential-gated and unperformed.
