...
description: "The F-6 endpoint registry primitive `defineEndpoint`: path templates, param kinds, body handling, and error integration."
---
...
This page is a companion to the broader [Client Reference](/docs/reference/client).
...
- [Scoped Clients Reference](/docs/reference/scoped-clients) — `PhoneNumberClient`
  Groups helpers and `GroupClient` bound-id methods over
  `@wats/graph/endpoints/groups` (WATS-133).
- [Client Reference](/docs/reference/client) — `GraphClient` construction, Transport
  seam, baseUrl/accessToken/apiVersion validation.
- [Errors Reference](/docs/reference/errors) — F-5 error code registry and seeded
  subclasses.
- [Transport and Testing](/docs/guides/transport-and-testing) — Transport
