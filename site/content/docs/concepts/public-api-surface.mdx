...
description: Compact ledger of the public package surfaces that ship today versus planned parity work.
---

<DocMeta status="active" appliesTo="0.3.x-alpha-tooling + WATS-31/32/33/34/35/WATS-37/38/39/40/41/42A/44/53/54/55 development line" lastReviewed="2026-05-02" />
