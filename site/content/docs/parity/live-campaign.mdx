---
title: WATS credentialed live-testing campaign
description: The runbook for validating WATS against live Meta/WhatsApp assets after explicit operator authorization, plus the execution log.
---

<DocMeta status="executed (2026-06-10; see execution log)" lastReviewed="2026-06-10" />
