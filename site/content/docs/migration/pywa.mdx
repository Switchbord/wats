...
- mutating admin APIs beyond profile/commerce updates, callback overrides, and phone registration/deregistration. (QR code CRUD and token exchange are now shape-only; catalog CRUD remains planned.)
