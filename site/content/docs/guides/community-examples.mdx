---
title: WATS-52 community examples and alpha launch scaffold
description: A narrow, offline-by-default scaffold for learning the public WATS package APIs without live WhatsApp credentials.
---

<DocMeta status="alpha docs/examples scaffold" appliesTo="WATS-52 / WATS-52A" />
