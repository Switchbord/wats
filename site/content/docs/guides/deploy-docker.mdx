...
<DocMeta status="planned" lastReviewed="2026-07-05" />

> Planned. The commands on this page do not run today; they document the
> intended shape. The repo ships a Railway-targeted Dockerfile for Railway
> deploys; production container publication is not supported.
