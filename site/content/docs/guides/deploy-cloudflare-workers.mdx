...
<DocMeta status="guide (F-12). Sketch only — WATS-25 closes the edge-runtime shape invariant; the full Miniflare integration test is tracked for a later step. WATS-96 adds the v25 webhook mTLS boundary note." />
