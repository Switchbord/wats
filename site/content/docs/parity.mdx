...
| Calling | `initiate_call` etc. | Initiate/pre-accept/accept/reject/terminate callables, call-button message and deep-link helpers, typed calling webhooks and filters. See [Calling Reference](/docs/reference/calling). | shape-only — no live call sessions yet. |
