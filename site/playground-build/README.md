...
`0.3.26`) into the two static assets the `/playground` route will load at
...
@wats/core 0.3.26 · @wats/graph 0.3.26 · @wats/http 0.3.26 ·
@wats/types 0.3.26 · @wats/crypto 0.3.26
