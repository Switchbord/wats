...
// Hero snippet body lands in T08 (typechecked against published @wats/*).
const HERO_SNIPPET_PLACEHOLDER = "// T08 wires the real snippet"
const CAPTURED_REQUEST_PLACEHOLDER = "// T08 wires the real snippet"
        ...
        tabs={[
          {
            ...
            content: (
              <pre className="mono overflow-x-auto text-sm leading-relaxed text-text-muted">
                <code>{HERO_SNIPPET_PLACEHOLDER}</code>
              </pre>
            ),
          },
          {
            ...
            content: (
              <pre className="mono overflow-x-auto text-sm leading-relaxed text-text-muted">
                <code>{CAPTURED_REQUEST_PLACEHOLDER}</code>
              </pre>
            ),
          },
        ]}
