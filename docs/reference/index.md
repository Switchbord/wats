...
- `docs/architecture/wats50-release-hygiene-policy.md`
- `docs/architecture/wats57-graph-endpoint-module-split-plan.md` — WATS-57 graph endpoint module split plan (design/test-planner only; no runtime code movement).
- `docs/architecture/wats58-graph-validation-utility-reuse-plan.md` — WATS-58 graph validation utility reuse plan (design/test-planner only; no runtime source movement or public utility exports).
...
- `docs/architecture/decisions/ADR-002-foundations-pivot.md`
- `docs/architecture/decisions/ADR-003-transport-and-crypto-abstractions.md`
- `docs/architecture/decisions/ADR-004-typed-updates-and-handler-model.md`
- `docs/architecture/decisions/ADR-005-endpoint-registry-and-error-taxonomy.md`
- `docs/architecture/decisions/ADR-006-testing-and-consumer-fixture-strategy.md`
