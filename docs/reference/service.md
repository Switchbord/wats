...
| `${profile.service.apiPrefix}/messages` | POST | service bearer | Sends a supported generic text, media, location, reaction, contacts, or basic interactive message body through Graph. |
...
- product/product-list/catalog/location-request interactive service message schemas beyond the current WATS-73 basic interactive slice
