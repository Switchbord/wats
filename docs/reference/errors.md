...
endpoint registry architecture defines the error code registry. `@wats/graph` exposes three
functions:
...
- `GraphCapabilityError` is reserved for a later architecture decision when
